...
session_start();
$user=$_SESSION['id'];
$fav="SELECT * FROM favourite WHERE User_id='$user'";
$result2=mysqli_query($connection,$fav);
 ?>
<!DOCTYPE html>
...
<head>
  ...
  <script src="javascript\e_change.js"></script>
  <script>
       ...
       <div class="col-sm-10">
        <div class="row" id="backgound">
          ...
          <div class="col-sm-4"><br><br>
            <h3 style="color:white;">Your Favourite Topics</h3>
          </div>
          <div class="col-sm-4"></div>
        <!--  <a href="assessment.php"><button type="button" class="btn btn-light" id="test">Previous</button> </a>-->
         ...
         <div class="col-sm-4">
           <table>
            ...
            while ($row=mysqli_fetch_assoc($result2)) { ?>
              <tr>
                <td><h4><?php echo $row['Topic'] ?></h4></td>
                <td></td>
              <?php echo  "<td> <h6 id='fav'><a href='delete.php?id=$row[Id]'>RemoveFavourite</a></h6></td>";?>
